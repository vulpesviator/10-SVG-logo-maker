...
describe("Shapes", () => {
  describe("createShape", () => {
    it("Should return a navy circle with a white W in the middle", () => {
      const shape = new Shapes("W", "Sans-Serif", "white", "Circle", "navy");
      const answers = { shapeSelection: "Circle" };

      expect(shape.createShape(answers))
        .toEqual(`<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="80" fill="navy" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="white" font-family="Arial, Helvetica, sans-serif">W</text></svg>`);
    });

    it("Should throw an error for an invalid shape selection", () => {
        const shape = new Shapes("W", "Sans-Serif", "white", "Rhombus", "navy");
