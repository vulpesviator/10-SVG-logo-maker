...
class Shapes {
    ...
    createShape(answers) {
        if (answers.shapeSelection === "Circle") {
            ...
            return `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">${shapeSelection.render()}<text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.textColor}" ${fontSelection.setFont()}>${this.monogram}</text></svg>`
